            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3 needs-validation" novalidate action="{{ route('vechicle-ic.update',$user->id) }}" method="POST" enctype="multipart/form-data">
				@method('PUT')
				@csrf
                                <div class="col-md-4">
                                    <label for="validationCustom01" class="form-label">Vehicle Make</label>
                                    <input type="text" class="form-control" id="validationCustom01" value="{{ $user->v_make }}" name="v_make" required>
                                    <div class="valid-feedback">Looks good!</div>
                                </div>
                                <div class="col-md-4">
                                    <label for="validationCustom02" class="form-label">Vehicle Model                                    </label>
                                    <input type="text" class="form-control" id="validationCustom02" name="v_model" value="{{ $user->v_model }}" required>
                                    <div class="valid-feedback">Looks good!</div>
                                </div>
                                <div class="col-md-4">
                                    <label for="validationCustomUsername" class="form-label">Vehicle Year  </label>
                                    <div class="input-group has-validation"> <span class="input-group-text" id="inputGroupPrepend">@</span>
                                        <input type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" value="{{ $user->v_year }}" name="v_year" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom03" value="{{ $user->vin }}" name="vin" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input text class="form-select" id="validationCustom04" value="{{ $user->v_reg }}" name="v_reg" required>
