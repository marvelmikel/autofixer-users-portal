                               ...
                               <th>{{$vechicle->v_model}}</th>
                                <th>{{$vechicle->v_year}}</th>
                                 <th>{{$vechicle->vin}}</th>
                                  ...
                                  <th>{{ $vechicle['updated_at']->diffForHumans() }}</th>>

                                       <td>
                                       <div class="d-flex order-actions">	
                                <a href="{{ route('vechicle-ac.edit',$vechicle->id) }}" class="ms-4 text-primary bg-light-primary border-0"><i class='bx bxs-edit' ></i></a>


  <form id="delete-form-{{ $vechicle->id }}" action="{{ route('vechicle-ac.destroy',$vechicle->id) }}" method="POST"  >
												@csrf
												@method('DELETE')
