...
class ServiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.company.service.index',compact('vechicles','users'));
    }
    ...
    {
        $users = User::where('is_auth' ,'=','company' )->get();
        return view('admin.company.service.create',compact('users'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.company.service.edit',compact('user'));
    }
